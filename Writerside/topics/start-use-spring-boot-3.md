...
<warning title="Spring Boot 2 ?">

如果你打算使用 Spring Boot v2.x 版本，请将后续可能会提到的 starter 的依赖坐标更改为:

`simbot-core-spring-boot-starter-v2`

此模块是用来兼容 Spring Boot v2 的，Java版本最低仅需Java11。

**但是！** 我们建议你优先考虑使用 Spring Boot 3。
...
如果阻碍你使用 Spring Boot 3 的仅仅是Java的版本（例如那该死的Java8），
