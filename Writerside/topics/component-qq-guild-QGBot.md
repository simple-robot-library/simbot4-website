...
## 标准库 Bot {id='stdlib-bot' collapsible="true" default-state="collapsed"}
...
var future = bot
        // 启动bot
        .startAsync() 
        // 转为直到bot被终止后结束的 future
        .thenCompose(r -> bot.asFuture()); 
...
你可以在
<a href="component-qq-guild-event-list.md#component-events" />
